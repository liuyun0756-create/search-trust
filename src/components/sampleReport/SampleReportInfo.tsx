        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          {cards.map((card, index) => (
            <motion.div
              ...
              whileHover={{ y: -8 }}
              className="bg-white rounded-[28px] p-6 md:p-7 flex flex-col min-h-[250px] border border-gray-100 shadow-[0_4px_20px_rgba(0,0,0,0.03)] hover:border-[#A5D020]/40 hover:shadow-[0_8px_30px_rgba(165,208,32,0.08)] transition-all duration-300 group"
            >
              <div className="w-12 h-12 rounded-2xl bg-[#F4F7E9] flex items-center justify-center mb-6 group-hover:bg-[#A5D020] transition-colors duration-300">
                <card.icon size={24} className="text-[#A5D020] group-hover:text-white transition-colors duration-300" />
              </div>

              <h3 className="text-[20px] font-bold text-[#1A212B] mb-5 leading-[1.2]">
                {card.title}
              </h3>
